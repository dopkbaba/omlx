class Omlx < Formula
  ...
  service do
    ...
    # Using port 8091 to avoid conflict with other local services on my machine
    # (8090 is taken by a local dev proxy)
    environment_variables PATH: std_service_path_env, OMLX_PORT: "8091"
  end
